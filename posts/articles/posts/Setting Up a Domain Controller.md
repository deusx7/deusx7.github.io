...
- Browse to where the windows server is located at and select it then click Next, If you don't have the ISO yet, check out this [Note](https://github.com/sec-fortress/Practical-Ethical-Hacking-Notes/blob/main/Active%20Directory%20Lab%20Build/Downloading%20Necessary%20ISOs.md) on how to go about downloading it :
